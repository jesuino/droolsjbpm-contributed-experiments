                ...
                if ( Util.isSetter( mName ) ) {
                    ...
                    if ( Util.isSimpleMethod( paramTypeName ) ) {
                        ...
                        if ( f == null ) {
                            ...
                            String fieldString = fieldValues.get( fieldSequences.get( f.getName() ) );
            ...
            for ( Method m : elementMethods ) {
                ...
                if ( Util.isSetter( mName ) && Util.isSimpleMethod( paramTypeName ) ) {
                    ...
                    if ( f == null ) {
                        ...
                        String fieldString = fieldValues.get( this.fieldSequences.get( f.getName() ) );
